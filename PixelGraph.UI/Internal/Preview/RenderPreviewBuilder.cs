...
{
    public interface IRenderPreviewBuilder : ITexturePreviewBuilder {}

    internal class RenderPreviewBuilder : TexturePreviewBuilder, IRenderPreviewBuilder
    {
        public RenderPreviewBuilder(IServiceProvider provider) : base(provider)
        {
            TagMap = tagMap;
        }
