...
namespace PixelGraph.UI.Internal.dx
{
    public static class DXUtils
	{
		...
		{
			if (obj == null) throw new ObjectDisposedException(typeof(T).Name);
			return obj;
		} 
		...
		public static void UpdateSubresource(this SharpDX.Direct3D11.DeviceContext devctxt, Stream source, SharpDX.Direct3D11.Resource resource, int subresource)
		{
