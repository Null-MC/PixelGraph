...
public class JavaLab13ImportTests : ImageTestBase
{
    ...
    public async Task CanImportLocal()
    {
        ...
        using var occlusionImage = await graph.GetImageAsync<L8>("assets/minecraft/textures/block/bricks/occlusion.png");
        ...
        using var f0Image = await graph.GetImageAsync<L8>("assets/minecraft/textures/block/bricks/f0.png");
        PixelAssert.Equals(8, f0Image);

        using var hcmImage = await graph.GetImageAsync<L8>("assets/minecraft/textures/block/bricks/hcm.png");
        PixelAssert.Equals(0, hcmImage);

        using var porosityImage = await graph.GetImageAsync<L8>("assets/minecraft/textures/block/bricks/porosity.png");
        PixelAssert.Equals(179, porosityImage);

        using var sssImage = await graph.GetImageAsync<L8>("assets/minecraft/textures/block/bricks/sss.png");
